...
function DrawerStyle(props) {
  return (
    <View style={{ flex: 1 }}>
      <ImageBackground
        source={{ uri: "https://i.imgur.com/2dszfRv.jpg" }}
        style={{ height: 230, width: 280, justifyContent: "flex-end" }}
      >
        <View style={{ marginLeft: 15, flexDirection: "column" }}>
          <Title style={styles.title}>
            {!props.loggedIn
              ? "Welcome!"
              : "Welcome, " + props.loggedIn.userFirstName}
          </Title>
        </View>
      </ImageBackground>
          ...
          {props.loggedIn && (
            ...
            >
              <Image
                ...
                source={{ uri: `${props.loggedIn.userImage}` }}
              />
